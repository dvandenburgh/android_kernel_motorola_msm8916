...
rm -f ~/android/kernel/upload/lux/*
cd flash_zip
zip -r ../arch/arm/boot/fire_kernel.zip ./
today=$(date +"-%d%m%Y")
mv ~/android/kernel/motorola/msm8916/arch/arm/boot/fire_kernel.zip ~/android/kernel/upload/lux/FireKernel-$anv-$dev-v$ver$today.zip
}
